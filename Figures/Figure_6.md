...
## Figure 6D- look at the percentage of reads ending at GTc.171
...
pctReads  %>% group_by(Promoter,Phenotype,background) %>% 
  ...
  ggtitle("Figure 6D: Percentage of polyA- reads ending at GTc.171") + 
...
## Figure 6E - compare the number of reads ending at GTc.171 and sRNA levels
